  ...
  <div id="demo">
    <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
      ...
      <tbody>
          ...
          <?php
            $m_ad=$_GET['m_ad'];
            $sorgu=mysql_query("SELECT * FROM servis WHERE tM_ad LIKE '%$m_ad%'");
            ...
            $sorgu=mysql_query("SELECT * FROM servis WHERE tM_ad LIKE '%$m_ad%' ORDER BY tM_ad LIMIT $baslangic,$kacar");
            ...
            while($oku=mysql_fetch_assoc($sorgu)){
              ...
              echo "<td><a href='tahsilat.php'><i class='icon-large icon-shopping-cart'></i></a> <a href='#' id='$s_no' onclick='servisSil(this.id)'><i class='icon-large icon-trash'></i></a></td>";
              echo "</tr>";
            }
            echo "<tr>";
            ...
            for($i=1;$i<=$kac_sayfa;$i++){
              echo "<li><a href='servisAra.php?p=$i&m_ad=".$m_ad."'>".$i."</a></li>";
            }
            echo "</ul>";
            echo "</td>";
