    ...
    <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
      ...
      <tbody>
          ...
          <?php
            ...
            $sorgu=mysql_query("SELECT * FROM servis ORDER BY tM_ad LIMIT $baslangic,$kacar");
            ...
            while($oku=mysql_fetch_assoc($sorgu)){
              ...
              echo "<td>";
              if($oku['tO_durum']=="1"){
                echo "<a href='tahsilat.php?s_no=$s_no'><i class='icon-large icon-shopping-cart'></i></a>";
              }
              echo " <a href='#' id='$s_no' onclick='servisSil(this.id)'><i class='icon-large icon-trash'></i></a></td>";
              echo "</tr>";
            }
            echo "<tr>";
            ...
            for($i=1;$i<=$kac_sayfa;$i++){
              echo "<li><a href='servis_listele.php?p=$i'>".$i."</a></li>";
            }
            echo "</ul>";
            echo "</td>";
